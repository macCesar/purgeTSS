...
'.preferred-provider-gps': { preferredProvider: Ti.Geolocation.Android.PROVIDER_GPS }
'.preferred-provider-network': { preferredProvider: Ti.Geolocation.Android.PROVIDER_NETWORK }
'.preferred-provider-passive': { preferredProvider: Ti.Geolocation.Android.PROVIDER_PASSIVE }
```