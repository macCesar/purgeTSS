...
function barTitleShadow(shadowValue = '#80000000') {
	...
	convertedStyles += `'.bar-title-shadow-xs[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 1, offset: { width: 0, height: 0 } } } }\n`;
	convertedStyles += `'.bar-title-shadow-sm[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 2, offset: { width: 0, height: 1 } } } }\n`;
	convertedStyles += `'.bar-title-shadow[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 4, offset: { width: 0, height: 2 } } } }\n`;
	convertedStyles += `'.bar-title-shadow-md[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 6, offset: { width: 0, height: 3 } } } }\n`;
	convertedStyles += `'.bar-title-shadow-lg[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 8, offset: { width: 0, height: 4 } } } }\n`;
	convertedStyles += `'.bar-title-shadow-xl[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 12, offset: { width: 0, height: 6 } } } }\n`;
	convertedStyles += `'.bar-title-shadow-2xl[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 14, offset: { width: 0, height: 8 } } } }\n`;
	convertedStyles += `'.bar-title-shadow-none[platform=ios]': { titleAttributes: { shadow: { color: null, blurRadius: null, offset: { width: 0, height: 0 } } } }\n`;
...
function barTitleShadowColor(modifiersAndValues) {
	return processProperties({ 'prop': 'titleAttributes: shadow - Bar Title Shadow - iOS Only', 'component': 'Ti.UI.TabGroup, Ti.UI.Window' }, {
...
function barTitleColor(modifiersAndValues) {
	return processProperties({ 'prop': 'titleAttributes - iOS Only', 'component': 'Ti.UI.TabGroup, Ti.UI.Window' }, {
...
function checkColorClasses(cleanClassName) {
	return (
		...
		cleanClassName.startsWith('bar-title-') ||
		cleanClassName.startsWith('bar-title-shadow-') ||
