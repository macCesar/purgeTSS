...
function shadow(shadowValue = '#80000000') {
	...
	convertedStyles += `'.shadow-xs': { elevation: 4, viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: 1, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.shadow-sm': { elevation: 8, viewShadowOffset: { x: 0, y: 1 }, viewShadowRadius: 2, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.shadow': { elevation: 16, viewShadowOffset: { x: 0, y: 2 }, viewShadowRadius: 4, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.shadow-md': { elevation: 24, viewShadowOffset: { x: 0, y: 3 }, viewShadowRadius: 6, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.shadow-lg': { elevation: 26, viewShadowOffset: { x: 0, y: 4 }, viewShadowRadius: 8, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.shadow-xl': { elevation: 34, viewShadowOffset: { x: 0, y: 6 }, viewShadowRadius: 12, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.shadow-2xl': { elevation: 38, viewShadowOffset: { x: 0, y: 8 }, viewShadowRadius: 14, viewShadowColor: '${shadowValue}' }\n`;

	convertedStyles += `'.shadow-inner': { elevation: 0, viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: null, viewShadowColor: null }\n`;
	convertedStyles += `'.shadow-outline': { elevation: 16, viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: 4, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.shadow-none': { elevation: 0, viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: null, viewShadowColor: null }\n`;
