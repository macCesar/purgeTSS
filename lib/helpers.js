...
function resetStyles() {
	...
	convertedStyles += singleValue('ImageView', '', 'hires', true);

	convertedStyles += `'View': { width: Ti.UI.SIZE, height: Ti.UI.SIZE }\n`;

	convertedStyles += `'.vertical': { layout: 'vertical', clipMode: Ti.UI.iOS.CLIP_MODE_DISABLED }\n`;
	convertedStyles += `'.horizontal': { layout: 'horizontal', clipMode: Ti.UI.iOS.CLIP_MODE_DISABLED }\n`;
	convertedStyles += singleValue('.clip-enabled', '', 'clipMode', 'Ti.UI.iOS.CLIP_MODE_ENABLED');
