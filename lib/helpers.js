...
function barTitle(modifiersAndValues) {
	// return processProperties('barTitle', {
	...
	return processProperties('barTitle', { 'bar-title': '{ titleAttributes : { color : {value} } }' }, modifiersAndValues);
}
exports.barTitle = barTitle;
...
function indicatorColor(modifiersAndValues) {
	return processModifiersAndProperties('indicatorColor', { 'indicator': '{ indicatorColor: {value} }' }, modifiersAndValues);
}
...
function indicatorStyle() {
	...
	return processModifiersAndProperties('indicatorStyle', { 'indicator-style': '{ style: {value} }' }, modifiersAndValues);
}
exports.indicatorStyle = indicatorStyle;

function statusBar() {
	return processProperties('statusBarStyle', {
		status: '{ statusBarStyle: {value} }'
	}, {
		bar: {
			ios: {
...
function tintColor(modifiersAndValues) {
	return processModifiersAndProperties('tint and tintColor', { 'tint': '{ tint: {value}, tintColor: {value} }' }, modifiersAndValues);
}
...
function backgroundBlendMode() {
	...
	convertedStyles += `'.bg-blend-clear': { mode: Ti.UI.BLEND_MODE_CLEAR }\n`;
	convertedStyles += `'.bg-blend-color-burn': { mode: Ti.UI.BLEND_MODE_COLOR_BURN }\n`;
	convertedStyles += `'.bg-blend-color-dodge': { mode: Ti.UI.BLEND_MODE_COLOR_DODGE }\n`;
	convertedStyles += `'.bg-blend-color': { mode: Ti.UI.BLEND_MODE_COLOR }\n`;
	convertedStyles += `'.bg-blend-copy': { mode: Ti.UI.BLEND_MODE_COPY }\n`;
	convertedStyles += `'.bg-blend-darken': { mode: Ti.UI.BLEND_MODE_DARKEN }\n`;
	convertedStyles += `'.bg-blend-destination-atop': { mode: Ti.UI.BLEND_MODE_DESTINATION_ATOP }\n`;
	convertedStyles += `'.bg-blend-destination-in': { mode: Ti.UI.BLEND_MODE_DESTINATION_IN }\n`;
	convertedStyles += `'.bg-blend-destination-out': { mode: Ti.UI.BLEND_MODE_DESTINATION_OUT }\n`;
	convertedStyles += `'.bg-blend-destination-over': { mode: Ti.UI.BLEND_MODE_DESTINATION_OVER }\n`;
	convertedStyles += `'.bg-blend-difference': { mode: Ti.UI.BLEND_MODE_DIFFERENCE }\n`;
	convertedStyles += `'.bg-blend-exclusion': { mode: Ti.UI.BLEND_MODE_EXCLUSION }\n`;
	convertedStyles += `'.bg-blend-hard-light': { mode: Ti.UI.BLEND_MODE_HARD_LIGHT }\n`;
	convertedStyles += `'.bg-blend-hue': { mode: Ti.UI.BLEND_MODE_HUE }\n`;
	convertedStyles += `'.bg-blend-lighten': { mode: Ti.UI.BLEND_MODE_LIGHTEN }\n`;
	convertedStyles += `'.bg-blend-luminosity': { mode: Ti.UI.BLEND_MODE_LUMINOSITY }\n`;
	convertedStyles += `'.bg-blend-multiply': { mode: Ti.UI.BLEND_MODE_MULTIPLY }\n`;
	convertedStyles += `'.bg-blend-normal': { mode: Ti.UI.BLEND_MODE_NORMAL }\n`;
	convertedStyles += `'.bg-blend-overlay': { mode: Ti.UI.BLEND_MODE_OVERLAY }\n`;
	convertedStyles += `'.bg-blend-plus-darker': { mode: Ti.UI.BLEND_MODE_PLUS_DARKER }\n`;
	convertedStyles += `'.bg-blend-plus-lighter': { mode: Ti.UI.BLEND_MODE_PLUS_LIGHTER }\n`;
	convertedStyles += `'.bg-blend-saturation': { mode: Ti.UI.BLEND_MODE_SATURATION }\n`;
	convertedStyles += `'.bg-blend-screen': { mode: Ti.UI.BLEND_MODE_SCREEN }\n`;
	convertedStyles += `'.bg-blend-soft-light': { mode: Ti.UI.BLEND_MODE_SOFT_LIGHT }\n`;
	convertedStyles += `'.bg-blend-source-atop': { mode: Ti.UI.BLEND_MODE_SOURCE_ATOP }\n`;
	convertedStyles += `'.bg-blend-source-in': { mode: Ti.UI.BLEND_MODE_SOURCE_IN }\n`;
	convertedStyles += `'.bg-blend-source-out': { mode: Ti.UI.BLEND_MODE_SOURCE_OUT }\n`;
	convertedStyles += `'.bg-blend-xor': { mode: Ti.UI.BLEND_MODE_XOR }\n`;
...
function pagingControlOnTop() {
	return processProperties('pagingControlOnTop', {
...
function gaps({ ...modifiersAndValues }) {
	...
	return processModifiersAndProperties('Gap for Grid System - top, right, bottom, left', objectPosition, modifiersAndValues);
}
exports.gaps = gaps;
...
function gridFlow() {
	...
	return processModifiersAndProperties('Grid Flow - layout', { 'grid': '{ layout: {value} }' }, modifiersAndValues);
}
...
function tiMedia() {
	...
	convertedStyles += processProperties('audioSessionCategory', {
		'audio-session': '{ audioSessionCategory: {value} }'
	}, {
	...
	convertedStyles += processProperties('audioType', {
	...
	convertedStyles += processProperties('Music Player - repeatMode', {
	...
	convertedStyles += processProperties('Music Player - shuffleMode', {
	...
	convertedStyles += processProperties('Background Size for compatibility with Tailwind’s classes - scalingMode', {
	...
	convertedStyles += processProperties('Image Scaling Mode - scalingMode', {
	...
	// Video Scaling Mode
	convertedStyles += processProperties('Video Scaling Mode - scalingMode', {
	...
	convertedStyles += processProperties('Video repeatMode', {
...
function keyboardAppearance() {
	return processProperties('keyboardAppearance', {
...
// loginKeyboardType ( Android and iOS )
function loginKeyboardType() {
	return processProperties('loginKeyboardType', {
...
// passwordKeyboardType ( Android and iOS )
// loginReturnKeyType ( Android and iOS )

function keyboardType() {
	return processProperties('keyboardType', {
...
function ellipsize() {
	let convertedStyles = processProperties('ellipsize ( for Labels )', {
...
function extendBackground() {
	...
	convertedStyles += `'.dont-extend-background': { extendBackground: false }\n`;
...
function autoLink() {
	return processProperties('autoLink', {
		autolink: '{ autoLink: {value} }'
	}, {
...
function borderStyle() {
	return processProperties('borderStyle', {
...
function keyboardDismissMode() {
	return processProperties('keyboardDismissMode', {
...
function lazyLoadingEnabled() {
	return processProperties('lazyLoadingEnabled', {
...
function showAsAction() {
	return processProperties('showAsAction', {
...
function autofillType() {
	return processProperties('autofillType', {
...
function returnKeyType() {
	return processProperties('returnKeyType', {
		'returnkey': '{ returnKeyType: {value} }'
	}, {
...
function gridSystem() {
	...
	let convertedStyles = processModifiersAndProperties('Grid Template Columns - width', { 'grid-cols': '{ width: {value} }' }, modifiersAndValues);
	...
	convertedStyles += processModifiersAndProperties('Grid Template Rows - height', { 'grid-rows': '{ height: {value} }' }, modifiersAndValues);
...
function gridColumnsStartEnd() {
	...
	let convertedStyles = processProperties('Grid Column Start/End - width', {
	...
	convertedStyles += processProperties('Grid Row Start/End - height', {
...
function borderRadiusExtraStyles({ ...modifiersAndValues }) {
	...
	return processModifiersAndProperties('Border Radius With Extra Styles - borderRadius', { 'rounded': '{ borderRadius: {value} }' }, modifiersAndValues);
}
...
function shiftMode() {
	return processProperties('shiftMode', {
		shift: '{ shiftMode: {value} }'
	}, {
		mode: {
			android: {
				default: true,
	...
	let convertedStyles = '\n// shiftMode Property\n';
	convertedStyles += `'.shift[platform=android]': { shiftMode: true }\n`;
	convertedStyles += `'.shift-off[platform=android]': { shiftMode: false }\n`;
...
function smoothScrollOnTabClick() {
	return processProperties('smoothScrollOnTabClick', {
		smooth: '{ smoothScrollOnTabClick: {value} }'
	}, {
		scroll: {
			android: {
				default: true,
...
function tabGroupStyle() {
	return processProperties('TabGroup Style', {
		tabs: '{ style: {value} }'
	}, {
		style: {
			android: {
				'default': 'Ti.UI.Android.TABS_STYLE_DEFAULT',
				'bottom': 'Ti.UI.Android.TABS_STYLE_BOTTOM_NAVIGATION'
			}
		}
	});
}
...
function iconIsMask() {
	return processProperties('iconIsMask', {
		'icon': '{ iconIsMask: {value} }'
	}, {
		is: {
			ios: {
				'mask': true,
...
function activeIconIsMask() {
	return processProperties('activeIconIsMask', {
		'active-icon': '{ activeIconIsMask: {value} }'
	}, {
		is: {
			ios: {
				'mask': true,
...
function bottomNavigation({ ...modifiersAndValues }) {
	...
	return processModifiersAndProperties('padding, paddingTop, paddingLeft, paddingRight, paddingBottom properties for CardView\n// And paddingLeft, paddingRight, paddingBottom for  bottomNavigation', objectPosition, modifiersAndValues);
}
...
function shadow(shadowValue = '#59000000') {
	...
	convertedStyles += `'.drop-shadow-xs': { viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: 1, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.drop-shadow-sm': { viewShadowOffset: { x: 0, y: 1 }, viewShadowRadius: 1, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.drop-shadow': { viewShadowOffset: { x: 0, y: 2 }, viewShadowRadius: 2, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.drop-shadow-md': { viewShadowOffset: { x: 0, y: 3 }, viewShadowRadius: 3, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.drop-shadow-lg': { viewShadowOffset: { x: 0, y: 4 }, viewShadowRadius: 4, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.drop-shadow-xl': { viewShadowOffset: { x: 0, y: 6 }, viewShadowRadius: 6, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.drop-shadow-2xl': { viewShadowOffset: { x: 0, y: 8 }, viewShadowRadius: 8, viewShadowColor: '${shadowValue}' }\n`;
	convertedStyles += `'.drop-shadow-none': { viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: null, viewShadowColor: null }\n`;
...
function shadowColor(modifiersAndValues) {
	return processModifiersAndProperties('Box Shadow Color - viewShadowColor', { 'shadow': '{ viewShadowColor: {value} }' }, modifiersAndValues);
}
...
function margin({ ...modifiersAndValues }) {
	...
	let convertedStyles = processModifiersAndProperties('top, right, bottom, left ( Margin )', objectPosition, modifiersAndValues);
	...
	convertedStyles += processModifiersAndProperties('top, right, bottom, left ( Negative Margin )', objectPosition, modifiersAndValues, '-');
...
function processProperties(header, selectorAndDeclarationBlock, selectorsAndValues, minusSigns = '') {
	let convertedStyles = `\n// ${header} Property\n`;
				...
				_.each(value, (_values, modifier) => {
					if (typeof _values === 'object') {
						_.each(_values, (__value, thirdSelector) => {
							convertedStyles += `'.${selectorSign}${mainSelector}-${secondSelector}${setModifier(thirdSelector)}${setModifier(modifier)}': ` + _.replace(declarationBlock, new RegExp("{value}", "g"), parseValue(__value, minusSigns)) + '\n';
						});
					} else {
						convertedStyles += `'.${selectorSign}${mainSelector}-${secondSelector}${setModifier(modifier)}': ` + _.replace(declarationBlock, new RegExp("{value}", "g"), parseValue(_values, minusSigns)) + '\n';
					}
				});
			} else {
				convertedStyles += `'.${selectorSign}${mainSelector}${setModifier(secondSelector)}': ` + _.replace(declarationBlock, new RegExp("{value}", "g"), parseValue(value, minusSigns)) + '\n';
			}
		});
	});
...
function processProperties2(header, selectorAndDeclarationBlock, selectorsAndValues, minusSigns = '') {
	let convertedStyles = `\n// ${header} Property\n`;
						...
						_.each(_values, (__value, thirdSelector) => {
							if (typeof __value === 'object') {
								_.each(__value, (___value, fourthSelector) => {
									convertedStyles += `'.${selectorSign}${mainSelector}-${secondSelector}${setModifier(thirdSelector)}${setModifier(fourthSelector)}${setModifier(modifier)}': ` + _.replace(declarationBlock, new RegExp("{value}", "g"), parseValue(___value, minusSigns)) + '\n';
								});
							} else {
								convertedStyles += `'.${selectorSign}${mainSelector}-${secondSelector}${setModifier(thirdSelector)}${setModifier(modifier)}': ` + _.replace(declarationBlock, new RegExp("{value}", "g"), parseValue(__value, minusSigns)) + '\n';
							}
