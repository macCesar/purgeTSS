...
function titleAttributesShadow(shadowValue = '#80000000') {
	let convertedStyles = processComments({
...
function tabbedBarStyle() {
	return processProperties({
		...
		'tabbed-bar-style': {
			// 'ios': {
			// 	'bar': 'Ti.UI.BUTTON_STYLE_OPTION_NEUTRAL',
			// 	'bordered': 'Ti.UI.BUTTON_STYLE_OPTION_NEUTRAL',
			// 	'done': 'Ti.UI.BUTTON_STYLE_OPTION_POSITIVE',
			// 	'plain': 'Ti.UI.BUTTON_STYLE_OPTION_NEUTRAL',
			// },
			'android': {
				'default': 'Titanium.UI.Android.TABS_STYLE_DEFAULT',
				'bottom-navigation': 'Titanium.UI.Android.TABS_STYLE_BOTTOM_NAVIGATION',
			}
		}
	});
}
...
function bottomNavigation({ ...modifiersAndValues }) {
	const objectPosition = {
		...
		't': '{ paddingTop: {value} }',
		'l': '{ paddingLeft: {value} }',
		'r': '{ paddingRight: {value} }',
		'b': '{ paddingBottom: {value} }',
	}
