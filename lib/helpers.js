...
function height({ ...modifiersAndValues }) {
	...
	return processProperties2({
		'prop': 'height',
		'component': 'Ti.UI.ActivityIndicator, Ti.UI.Animation, Ti.UI.iPad.Popover, Ti.UI.ListItem, Ti.UI.View'
	}, {
		'h-': '{ height: {value} }'
	}, {
...
function margin({ ...modifiersAndValues }) {
	...
	let convertedStyles = processProperties2({
		'prop': 'top, right, bottom, left ( Margin )',
		'component': 'Ti.UI.ActivityIndicator, Ti.UI.Animation, Ti.UI.View, Ti.UI.Window'
	...
	convertedStyles += processProperties2({
...
function margin2({ ...modifiersAndValues }) {
	let objectPosition = {
		'bottom-': '{ bottom: {value} }',
		'left-': '{ left: {value} }',
		'right-': '{ right: {value} }',
...
function activityIndicatorStyle() {
	return processProperties({
		'prop': 'style',
		'component': 'Ti.UI.ActivityIndicator'
	}, {
...
function allowsMultipleSelectionDuringEditing() {
	return processProperties({
		...
		'component': 'Ti.UI.ListView, Ti.UI.TableView'
	}, {
...
function audioStreamType() {
	return processProperties2({
		...
		'component': 'Ti.Android.Notification'
	}, {
...
function autoAdjustScrollViewInsets() {
	return processProperties({
		...
		'dont-auto-adjust-scroll-view-inset': {
			'ios': {
				'default': false,
			}
		},
...
function autocapitalization() {
	return processProperties({
		...
		'component': 'Ti.UI.SearchBar, Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function autofillType() {
	return processProperties({
		'prop': 'autofillType',
		'component': 'Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function autoLink() {
	return processProperties({
		'prop': 'autoLink',
		'component': 'Ti.UI.Label, Ti.UI.TextArea, Ti.UI.TextField'
	}, {
		'auto': '{ autoLink: {value} }'
	}, {
		'link': {
...
function backgroundRadialGradient() {
	let convertedStyles = processComments({
		...
		component: 'Ti.UI.ListItem, Ti.UI.View'
	});

	convertedStyles += `'.bg-radial[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '125%', endRadius: '0%' } }\n`;
	convertedStyles += `'.bg-radial-to-b[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '150%', endRadius: '0%', startPoint: { x: '50%', y: '0%' }, endPoint: { x: '50%', y: '0%' } } }\n`;
	convertedStyles += `'.bg-radial-to-bl[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '150%', endRadius: '0%', startPoint: { x: '100%', y: '0%' }, endPoint: { x: '100%', y: '0%' } } }\n`;
	convertedStyles += `'.bg-radial-to-l[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '150%', endRadius: '0%', startPoint: { x: '100%', y: '50%' }, endPoint: { x: '100%', y: '50%' } } }\n`;
	convertedStyles += `'.bg-radial-to-tl[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '150%', endRadius: '0%', startPoint: { x: '100%', y: '100%' }, endPoint: { x: '100%', y: '100%' } } }\n`;
	convertedStyles += `'.bg-radial-to-t[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '150%', endRadius: '0%', startPoint: { x: '50%', y: '100%' }, endPoint: { x: '50%', y: '100%' } } }\n`;
	convertedStyles += `'.bg-radial-to-tr[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '150%', endRadius: '0%', startPoint: { x: '0%', y: '100%' }, endPoint: { x: '0%', y: '100%' } } }\n`;
	convertedStyles += `'.bg-radial-to-r[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '150%', endRadius: '0%', startPoint: { x: '0%', y: '50%' }, endPoint: { x: '0%', y: '50%' } } }\n`;
	convertedStyles += `'.bg-radial-to-br[platform=ios]': { backgroundGradient: { type: 'radial', backfillStart: true, backfillEnd: true, startRadius: '150%', endRadius: '0%', startPoint: { x: '0%', y: '0%' }, endPoint: { x: '0%', y: '0%' } } }\n`;
...
function borderStyle() {
	return processProperties({
		'prop': 'borderStyle',
		'component': 'Ti.UI.Picker[android], Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function caseInsensitiveSearch() {
	return processProperties({
		...
		'default': '{ caseInsensitiveSearch: {value} }'
	}, {
...
function defaultItemTemplate() {
	return processProperties({
		...
		'list': '{ defaultItemTemplate: {value} }'
	}, {
		'item-template': {
...
function dimBackgroundForSearch() {
	return processProperties({
		...
		'dim-background-for-search': {
			'ios': {
				'default': true,
			}
		},
		'dont-dim-background-for-search': {
			'ios': {
				'default': false,
			}
		},
...
function disableBounce() {
	return processProperties({
		...
		'component': 'Ti.UI.ListView, Ti.UI.ScrollableView, Ti.UI.ScrollView, Ti.UI.WebView'
	}, {
...
function displayUtilities() {
	return processProperties({
		'prop': 'visible',
		'component': 'Ti.Android.MenuItem, Ti.UI.Animation, Ti.UI.Picker, Ti.UI.ScrollableView, Ti.UI.ShortcutItem, Ti.UI.View'
	}, {
...
function draggingType() {
	return processProperties({
		'prop': 'draggingType',
		'component': 'For the Animation Component'
	}, {
...
function drawerIndicatorEnabled() {
	return processProperties({
		...
		'component': 'Ti.UI.Android.DrawerLayout'
	}, {
		'drawer': '{ drawerIndicatorEnabled: {value} }',
	}, {
		'indicator': {
			'android': {
				'enabled': true,
...
function dropShadow(values) {
	let shadowValue = '#80000000';
	let convertedStyles = processComments({
		'prop': 'shadowOffset, shadowRadius, shadowColor - Drop Shadow in Tailwind',
		'component': 'Ti.UI.Button, Ti.UI.Label'
	});
...
function editable() {
	return processProperties({
		'prop': 'editable',
		'component': 'Ti.UI.DashboardView, Ti.UI.SearchBar, Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function enabled() {
	return processProperties2({
		'prop': 'enabled',
		'component': 'Ti.UI.Button, Ti.UI.iOS.Stepper, Ti.Android.MenuItem, Ti.UI.Slider, Ti.UI.Switch'
	}, {
...
function enableZoomControls() {
	return processProperties({
		...
		'component': 'Ti.UI.ImageView. Ti.UI.WebView'
	}, {
...
function exitOnClose() {
	return processProperties({
		...
		'component': 'Ti.UI.TabGroup, Ti.UI.Window'
	}, {
...
function fontStyle() {
	return processProperties({
		'prop': 'fontStyle',
		'component': 'Ti.UI.ActivityIndicator, Ti.UI.Button, Ti.UI.Label, Ti.UI.ListItem, Ti.UI.Picker, Ti.UI.PickerColumn, Ti.UI.PickerRow, Ti.UI.ProgressBar, Ti.UI.Switch, Ti.UI.TableViewRow, Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function fullscreen() {
	return processProperties({
		'prop': 'fullscreen',
		'component': 'Ti.Media.VideoPlayer[android], Ti.UI.TextArea, Ti.UI.TextField, Ti.UI.Window'
	}, {
...
function gridColumnsStartEnd() {
	...
	let convertedStyles = processProperties({
		...
		'component': 'Ti.UI.ActivityIndicator, Ti.UI.Animation, Ti.UI.iPad.Popover, Ti.UI.View, Ti.UI.Window'
	}, {
...
function gridFlow() {
	return processProperties({
		'prop': 'layout',
		'component': 'Ti.UI.View', 'description': 'Grid Flow - layout'
	}, {
		'grid': '{ layout: {value} }'
	}, {
		'default': 'horizontal',
...
function iconified() {
	return processProperties({
		'prop': 'iconified',
		'component': 'Ti.UI.Android.SearchView, Ti.UI.Android.SearchBar'
	}, {
...
function iconifiedByDefault() {
	return processProperties({
		...
		'component': 'Ti.UI.Android.SearchView, Ti.UI.SearchBar'
	}, {
...
function keyboardAppearance() {
	return processProperties({
		...
		'component': 'Ti.UI.AlertDialog, Ti.UI.SearchBar, Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function layout() {
	return processProperties({
		'prop': 'layout',
		'component': 'Ti.UI.OptionBar, Ti.UI.View'
	}, {
...
function leftDrawerLockMode() {
	return processProperties({
		...
		'left-drawer': '{ leftDrawerLockMode: {value} }',
	}, {
		'lock-mode': {
			'android': {
				'locked-closed': 'Ti.UI.Android.DrawerLayout.LOCK_MODE_LOCKED_CLOSED',
...
exports.notificationMargins = notificationMargins;
...
function origin() {
	...
	let convertedStyles = processComments({
		'prop': 'anchorPoint',
		'component': 'Ti.UI.Animation, Ti.UI.View'
	});
...
function overlayEnabled() {
	return processProperties2({
		...
		'component': 'Ti.UI.ScrollableView'
	}, {
...
function overScrollMode() {
	return processProperties2({
		...
		'component': 'Ti.UI.ScrollableView, Ti.UI.ScrollView, Ti.UI.TableView, Ti.UI.WebView'
	}, {
...
function preventCornerOverlap() {
	return processProperties2({
		...
		'component': 'Ti.UI.Android.CardView'
	}, {
...
function previewActionStyle() {
	return processProperties({
		'prop': 'style - iOS Only',
		'component': 'Ti.UI.iOS.PreviewAction, Ti.UI.iOS.PreviewActionGroup'
	}, {
		'preview-action': '{ style: {value} }'
	}, {
		'style': {
			'ios': {
...
function progressIndicatorCancelable() {
	return processProperties({
		'prop': 'cancelable - Android Only',
		'component': 'Ti.UI.Android.ProgressIndicator'
	}, {
		'default': '{ cancelable: {value} }'
	}, {
		'cancelable': {
			'android': {
				'default': true
...
exports.progressIndicatorCancelable = progressIndicatorCancelable;

function progressIndicatorCancelOnTouchOutside() {
	return processProperties({
		'prop': 'canceledOnTouchOutside - Android Only',
		'component': 'Ti.UI.Android.ProgressIndicator'
	}, {
		'default': '{ canceledOnTouchOutside: {value} }'
	}, {
...
exports.progressIndicatorCancelOnTouchOutside = progressIndicatorCancelOnTouchOutside;
...
exports.rDrawable = rDrawable;

function requestedOrientation() {
	return processProperties({
		'prop': 'requestedOrientation - Android Only',
		'component': 'Ti.Android.Activity'
	}, {
		'requested': '{ requestedOrientation: {value} }',
	}, {
		'orientation': {
			'android': {
...
function returnKeyType() {
	return processProperties({
		'prop': 'returnKeyType',
		'component': 'Ti.UI.AlertDialog, Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function rightDrawerLockMode() {
	return processProperties({
		...
		'right-drawer': '{ rightDrawerLockMode: {value} }',
	}, {
		'lock-mode': {
			'android': {
				'locked-closed': 'Ti.UI.Android.DrawerLayout.LOCK_MODE_LOCKED_CLOSED',
...
function scrollIndicatorStyle() {
	return processProperties({
		...
		'component': 'Ti.UI.ListView, Ti.UI.ScrollView, Ti.UI.TableView'
	}, {
...
function scrollingEnabled() {
	return processProperties({
		...
		'component': 'Ti.UI.ScrollableView, Ti.UI.ScrollView'
	}, {
...
function scrollsToTop() {
	return processProperties({
		...
		'component': 'Ti.UI.ScrollView, Ti.UI.TableView, Ti.UI.TextArea, Ti.UI.WebView'
	}, {
...
function searchBarStyle() {
	return processProperties({
		'prop': 'style - iOS Only',
		'component': 'Ti.UI.SearchBar'
	}, {
		'search-bar': '{ style: {value} }'
	}, {
		'style': {
			'ios': {
...
function selectionStyle() {
	return processProperties({
		'prop': 'selectionStyle',
		'component': 'Ti.UI.ListItem, Ti.UI.TableViewRow'
	}, {
	...
	return processProperties({
		...
		'status-bar': {
			'ios': {
				...
				'animation-fade': 'Ti.UI.iOS.StatusBar.ANIMATION_STYLE_FADE',
				'animation-none': 'Ti.UI.iOS.StatusBar.ANIMATION_STYLE_NONE',
				'animation-slide': 'Ti.UI.iOS.StatusBar.ANIMATION_STYLE_SLIDE',
			}
		}
	});
}
...
function submitEnabled() {
	return processProperties({
		...
		'component': 'Ti.UI.Android.SearchView'
	}, {
	...
	return processProperties({
		...
		'tabbed-bar-style': {
			'default': {
				...
				'plain': 'Ti.UI.BUTTON_STYLE_OPTION_POSITIVE',
				'plain': 'Ti.UI.BUTTON_STYLE_OUTLINED',
				'plain': 'Ti.UI.BUTTON_STYLE_TEXT',
			},
			'android': {
...
function textAlign() {
	return processProperties({
		'prop': 'textAlign',
		'component': 'Ti.UI.Button, Ti.UI.Label, Ti.UI.Switch, Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function tiMedia() {
	...
	convertedStyles += processProperties({
		...
		'component': 'Ti.Media.AudioPlayer, Ti.Media.Sound'
	}, {
...
function titleAttributesShadow() {
	...
	convertedStyles += `'.title-attributes-shadow-xs[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 1, offset: { width: 0, height: 0 } } } }\n`;
	convertedStyles += `'.title-attributes-shadow-sm[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 2, offset: { width: 0, height: 1 } } } }\n`;
	convertedStyles += `'.title-attributes-shadow[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 4, offset: { width: 0, height: 2 } } } }\n`;
	convertedStyles += `'.title-attributes-shadow-md[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 6, offset: { width: 0, height: 3 } } } }\n`;
	convertedStyles += `'.title-attributes-shadow-lg[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 8, offset: { width: 0, height: 4 } } } }\n`;
	convertedStyles += `'.title-attributes-shadow-xl[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 12, offset: { width: 0, height: 6 } } } }\n`;
	convertedStyles += `'.title-attributes-shadow-2xl[platform=ios]': { titleAttributes: { shadow: { color: '${shadowValue}', blurRadius: 14, offset: { width: 0, height: 8 } } } }\n`;
	convertedStyles += `'.title-attributes-shadow-none[platform=ios]': { titleAttributes: { shadow: { color: null, blurRadius: null, offset: { width: 0, height: 0 } } } }\n`;
...
function touchFeedback() {
	return processProperties({
		...
		'component': 'Ti.UI.ListView, Ti.UI.TableView, Ti.UI.View'
	}, {
...
function translucent() {
	return processProperties({
		...
		'component': 'Ti.UI.iOS.Toolbar, Ti.UI.TabGroup, Ti.UI.Toolbar, Ti.UI.Window'
	}, {
...
function borderRadius({ ...modifiersAndValues }) {
	...
	return processProperties({
		...
		'component': 'Ti.UI.Android.CardView, Ti.UI.View'
	}, {
...
function bottomNavigation({ ...modifiersAndValues }) {
	...
	return processProperties({
		...
		'component': 'Ti.UI.Android.CardView, Ti.UI.TabGroup, Ti.UI.ScrollableView'
	},
		objectPosition,
		{
			'default': {
...
function elevation({ ...modifiersAndValues }) {
	...
	return processProperties({
		...
		'component': 'Ti.UI.Android.CardView, Ti.UI.Animation, Ti.UI.View'
	}, {
...
function minimumFontSize({ ...modifiersAndValues }) {
	...
	return processProperties({
		...
		'component': 'Ti.UI.label, Ti.UI.TextField'
	}, {
...
function opacity(modifiersAndValues) {
	return processProperties({
		'prop': 'opacity',
		'component': 'Ti.UI.Animation, Ti.UI.TableViewRow, Ti.UI.View, Ti.UI.Window'
	}, {
...
function padding({ ...modifiersAndValues }) {
	...
	return processProperties({
		...
		'component': 'Ti.UI.Android.CardView, Ti.UI.TextArea, Ti.UI.TextField'
	}, objectPosition, modifiersAndValues);
}
...
function transitionDuration(modifiersAndValues) {
	return processProperties2({
		'prop': 'duration',
		'component': 'Ti.UI.Animation, Ti.UI.ImageView'
	}, {
...
function activeTintColor(modifiersAndValues) {
	return processProperties({
		...
		'component': 'Ti.UI.Tab, Ti.UI.TabGroup'
	}, {
...
function backgroundColor(modifiersAndValues) {
	return processProperties2({
		...
		'component': 'Ti.UI, Ti.UI.Android.CardView, Ti.UI.Animation, Ti.UI.iPad.Popover, Ti.UI.ListItem, Ti.UI.Picker, Ti.UI.Tab, Ti.UI.TableView, Ti.UI.View, Ti.UI.Window'
	}, {
...
function backgroundFocusedColor(modifiersAndValues) {
	return processProperties2({
		...
		'component': 'Ti.UI.Tab, Ti.UI.View'
	}, {
...
function backgroundSelectedColor(modifiersAndValues) {
	return processProperties({
		...
		'component': 'Ti.UI.Button, Ti.UI.ListItem, Ti.UI.TableViewRow, Ti.UI.View'
	}, {
...
function barColor(modifiersAndValues) {
	return processProperties({
		'prop': 'barColor',
		'component': 'Ti.UI.EmailDialog, Ti.UI.SearchBar, Ti.UI.TabGroup, Ti.UI.Toolbar, Ti.UI.Window'
	}, {
		'bar': '{ barColor: {value} }'
	}, modifiersAndValues);
}
...
function hintTextColor(modifiersAndValues) {
	return processProperties({
		'prop': 'hintTextColor',
		'component': 'Ti.UI.Android.SearchView, Ti.UI.SearchBar, Ti.UI.TextArea, Ti.UI.TextField'
	}, {
...
function selectedButtonColor(modifiersAndValues) {
	return processProperties({
		...
		'selected': '{ selectedButtonColor: {value} }'
	}, {
		'button': {
			'ios': modifiersAndValues
		}
...
function selectedColor({ ...modifiersAndValues }) {
	return processProperties({
		...
		'component': 'Ti.UI.Button, Ti.UI.ListItem, Ti.UI.TableViewRow'
	}, {
...
function selectedTextColor(modifiersAndValues) {
	return processProperties({
		...
		'selected': '{ selectedTextColor: {value} }'
	}, {
		'text': {
			'ios': modifiersAndValues
		}
...
function tabsBackgroundSelectedColor(modifiersAndValues) {
	return processProperties({
		...
		'tabs-bg': '{ tabsBackgroundSelectedColor: {value} }'
	}, {
		'selected': {
			'android': modifiersAndValues
		}
...
function textColor(modifiersAndValues) {
	return processProperties({
		'prop': 'color',
		'component': 'Ti.UI.Button, Ti.UI.Label, Ti.UI.PickerRow, Ti.UI.SearchBar, Ti.UI.TextArea, Ti.UI.ActivityIndicator, Ti.UI.Animation, Ti.UI.ListItem, Ti.UI.ProgressBar, Ti.UI.Switch, Ti.UI.TableViewRow, Ti.UI.TextField, Ti.UI.Android.SearchView'
	}, {
...
function tintColor(modifiersAndValues) {
	return processProperties({
		'prop': 'tint and tintColor',
		'component': 'Ti.UI, Ti.UI.AlertDialog, Ti.UI.Button, Ti.UI.ImageView, Ti.UI.iOS.Stepper, Ti.UI.ProgressBar, Ti.UI.RefreshControll, Ti.UI.Slider, Ti.UI.Switch, and `tint` for Ti.UI.MaskedImage'
	}, {
...
function titleAttributesColor(modifiersAndValues) {
	return processProperties({
		...
		'title': '{ titleAttributes: { color: {value} } }'
	}, {
		'attributes': {
			'ios': modifiersAndValues
		}
...
function titleAttributesShadowColor(modifiersAndValues) {
	return processProperties({
		...
		'title': '{ titleAttributes: { shadow: { color: {value} } } }'
	}, {
		'attributes-shadow': {
			'ios': modifiersAndValues
		}
...
function touchFeedbackColor(modifiersAndValues) {
	return processProperties({
		...
		'touch': '{ touchFeedback: true, touchFeedbackColor: {value} }'
	}, {
		'feedback': {
			'android': modifiersAndValues
		}
...
function trackTintColor(modifiersAndValues) {
	return processProperties({
		'prop': 'trackTintColor',
		'component': 'Ti.UI.ProgressBar, Ti.UI.Slider'
	}, {
			...
			if (classesWithOpacityValues.length > 0) {
				classesWithOpacityValues.forEach(opacityValue => {
					...
					if (opacityIndex > -1) {
						...
						let classWithoutDecimalOpacity = `${twStylesArray[opacityIndex].replace(new RegExp(defaultHexValue.replace(/[.*+?^${}()|[\]\\]/g, '\\$&'), 'g'), `#${opacityValue.transparency}${defaultHexValue.substring(1)}`)}`;
...
const arbitraryValuesTable = {
	...
	'bar': 'barColor: {value}',
	'bg-focused': 'backgroundFocusedColor: {value}',
	'bg-selected-from': 'backgroundGradient: { colors: [ {value1}, {value} ] }',
	'bg-selected-to': 'backgroundGradient: { colors: [ {value} ] }',
	'bg-selected': 'backgroundSelectedColor: {value}',
	'bg': 'backgroundColor: {value}',
...
function formatArbitraryValues(arbitraryValue, fromXMLs = false) {
	...
	if (splitedContent.length === 1) {
		...
		let rule = `${splitedContent[0]}-${splitedContent[1]}-${splitedContent[2]}-${splitedContent[3]}`;
		let value = splitedContent[4].match(/(?<=\().*(?=\))/).pop();
		let properties = arbitraryValuesTable[rule];
...
function checkColorClasses(cleanClassName) {
	return (
		...
		cleanClassName.startsWith('bg-selected-from-') ||
		cleanClassName.startsWith('bg-selected-to-') ||
		...
		cleanClassName.startsWith('selected-button-') ||
		cleanClassName.startsWith('selected-text-') ||
		...
		cleanClassName.startsWith('title-attributes-') ||
		cleanClassName.startsWith('title-attributes-shadow-') ||
...
//! Private Functions
function processProperties2(info, selectorAndDeclarationBlock, selectorsAndValues, debug = false) {
	...
	_.each(selectorAndDeclarationBlock, (declarationBlock, mainSelector) => {
		let minusSigns = (mainSelector.startsWith('-')) ? '-' : '';
			...
			_.each(rulesAndValuesPair, (value, rule) => {
				...
				if (typeof value === 'object') {
					_.each(value, (_value, key) => {
						...
						let valores = _.replace(declarationBlock, new RegExp("{value}", "g"), parseValue(_value, minusSigns));
						convertedStyles += defaultModifier(key) ? `'.${setModifier2(mainSelector)}${setModifier2(rule)}${setModifier2(selector)}': ${valores}\n` : `'.${setModifier2(mainSelector)}${setModifier2(rule)}-${key}${setModifier2(selector)}': ${valores}\n`;
					});
				} else {
					let valores = _.replace(declarationBlock, new RegExp("{value}", "g"), parseValue(value, minusSigns));
					convertedStyles += `'.${setModifier2(mainSelector)}${setModifier2(rule)}${setModifier2(selector)}': ${valores}\n`;
				}
			});
		});
	});
							...
							if (typeof __value === 'object') {
								_.each(__value, (___value, fourthSelector) => {
									...
									convertedStyles += (mainSelector === 'default') ?
										...
										`'.${selectorSign}${mainSelector}${setModifier(secondSelector)}${setModifier(thirdSelector)}${setModifier(fourthSelector)}${setModifier(modifier)}': ${valores}\n`;
								});
							} else {
								...
								convertedStyles += (mainSelector === 'default') ?
									...
									`'.${selectorSign}${mainSelector}${setModifier(secondSelector)}${setModifier(thirdSelector)}${setModifier(modifier)}': ${valores}\n`;
							}
						});
					} else {
...
function setModifier2(modifier) {
...
function formatearClase(mainSelector, declarationBlock, selector, rule, value) {
	if (mainSelector === 'default') {
		return `'.${selector}': { ${rule}: ${value}; }\n`;
	} else if (mainSelector === 'ios') {
		//
	} else if (mainSelector === 'android') {
		//
	}
	console.log('mainSelector:', mainSelector, 'declarationBlock:', declarationBlock, 'selector:', selector, 'rule:', rule, 'value:', value);
}

function animated() {
	return processProperties2({
		'prop': 'animated',
		'component': 'Ti.UI.Button, Ti.UI.Slider'
	}, {
