...
function borderStyle() {
	...
	convertedStyles += `'.input-borderstyle-line': { borderStyle: Ti.UI.INPUT_BORDERSTYLE_LINE }\n`;
	convertedStyles += `'.input-borderstyle-none': { borderStyle: Ti.UI.INPUT_BORDERSTYLE_NONE }\n`;
	convertedStyles += `'.input-borderstyle-bezel': { borderStyle: Ti.UI.INPUT_BORDERSTYLE_BEZEL }\n`;
	convertedStyles += `'.input-borderstyle-filled': { borderStyle: Ti.UI.INPUT_BORDERSTYLE_FILLED }\n`;
	convertedStyles += `'.input-borderstyle-rounded': { borderStyle: Ti.UI.INPUT_BORDERSTYLE_ROUNDED }\n`;
	convertedStyles += `'.input-borderstyle-underlined': { borderStyle: Ti.UI.INPUT_BORDERSTYLE_UNDERLINED }\n`;
