...
function borderRadius(modifiersAndValues) {
	...
	return processProperties({
		...
		'modules': 'Ti.UI.Android.CardView, Ti.UI.View'
	}, {
...
function tintColor(modifiersAndValues) {
	return processProperties({
		...
		'modules': 'Ti.UI, Ti.UI.AlertDialog, Ti.UI.Button, Ti.UI.ImageView, Ti.UI.iOS.Stepper, Ti.UI.ProgressBar, Ti.UI.RefreshControll, Ti.UI.Slider, Ti.UI.Switch, and `tint` for Ti.UI.MaskedImage'
	}, {
