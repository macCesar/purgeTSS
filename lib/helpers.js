...
function shadow(shadowValue = '#80000000') {
	let convertedStyles = processComments({ 'prop': 'viewShadowOffset, viewShadowRadius, viewShadowColor - Box Shadow in Tailwind - iOS Only', 'component': 'Ti.UI.View' });
	...
	convertedStyles += processComments({ 'prop': 'elevation - Box Shadow in Tailwind - Android Only', 'component': 'Ti.UI.Android.CardView, Ti.UI.Animation, Ti.UI.View' });
...
function shadowColor(modifiersAndValues) {
	return processProperties({ 'prop': 'viewShadowColor - Box Shadow in Tailwind - iOS Only', 'component': 'Ti.UI.View' }, {
