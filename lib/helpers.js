...
function autocapitalization() {
	...
	convertedStyles += `'.capitalize-words': { autocapitalization: Ti.UI.TEXT_AUTOCAPITALIZATION_WORDS }\n`;
	convertedStyles += `'.capitalize-sentences': { autocapitalization: Ti.UI.TEXT_AUTOCAPITALIZATION_SENTENCES }\n`;
...
function keyboardAppearance() {
	...
	convertedStyles += `'.keyboard-appearance-alert[platform=ios]': { keyboardAppearance: Ti.UI.KEYBOARD_APPEARANCE_ALERT }\n`;
...
function keyboardType() {
	...
	convertedStyles += `'.keyboard-type-url[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_URL }\n`;
	convertedStyles += `'.keyboard-type-ascii[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_ASCII }\n`;
	convertedStyles += `'.keyboard-type-email[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_EMAIL }\n`;
	convertedStyles += `'.keyboard-type-twitter[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_TWITTER }\n`;
	convertedStyles += `'.keyboard-type-default[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_DEFAULT }\n`;
	convertedStyles += `'.keyboard-type-phone-pad[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_PHONE_PAD }\n`;
	convertedStyles += `'.keyboard-type-websearch[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_WEBSEARCH }\n`;
	convertedStyles += `'.keyboard-type-number-pad[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_NUMBER_PAD }\n`;
	convertedStyles += `'.keyboard-type-decimal-pad[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_DECIMAL_PAD }\n`;
	convertedStyles += `'.keyboard-type-namephone-pad[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_NAMEPHONE_PAD }\n`;
	convertedStyles += `'.keyboard-type-numbers-punctuation[platform=ios]': { keyboardType: Ti.UI.KEYBOARD_TYPE_NUMBERS_PUNCTUATION }\n`;
