...
function statusBar() {
	return processProperties({ 'prop': 'statusBarStyle', 'component': 'Ti.UI.Window' }, {
...
function autoAdjustScrollViewInsets() {
	return processProperties({ 'prop': 'autoAdjustScrollViewInsets', 'component': 'Ti.UI.Window' }, {
...
function largeTitleEnabled() {
	return processProperties({ 'prop': 'largeTitleEnabled', 'component': 'Ti.UI.Window' }, {
...
function includeOpaqueBars() {
	return processProperties({ 'prop': 'includeOpaqueBars', 'component': 'Ti.UI.Window' }, {
...
function extendEdges() {
	return processProperties({ 'prop': 'extendEdges', 'component': 'Ti.UI.Window' }, {
...
function translucent() {
	return processProperties({ 'prop': 'translucent', 'component': 'Ti.UI.iOS.Toolbar, Ti.UI.TabGroup, Ti.UI.Toolbar, Ti.UI.Window' }, {
...
function shiftMode() {
	return processProperties({ 'prop': 'shiftMode', 'component': 'Ti.UI.TabGroup' }, {
...
function tabBarHidden() {
	return processProperties({ 'prop': 'tabBarHidden', 'component': 'Ti.UI.Window[iOS]' }, {
...
function keepSectionsInSearch() {
	let convertedStyles = processComments({ 'prop': 'keepSectionsInSearch', 'component': 'Ti.UI.ListView' });
