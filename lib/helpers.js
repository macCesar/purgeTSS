...
function boxShadow(shadowValue = '#80000000') {
	let convertedStyles = processComments({ 'prop': 'elevation - Box Shadow Effect in Tailwind - Android Only', 'component': 'Ti.UI.Android.CardView, Ti.UI.Animation, Ti.UI.View' });
	...
	convertedStyles += processComments({ 'prop': 'viewShadowOffset, viewShadowRadius, viewShadowColor - Box Shadow Effect in Tailwind - iOS Only', 'component': 'Ti.UI.View' });
...
function theme() {
	return processProperties({ 'prop': 'theme - Android Only', 'component': 'Ti.UI.Window' }, {
		'theme': '{ theme: "{value}" }',
	}, {
		'titanium': {
			'android': {
...
function titleAttributesShadow(shadowValue = '#80000000') {
	...
	let convertedStyles = processComments({ 'prop': 'titleAttributes: shadow, color, blurRadius, offset - iOS Only', 'component': 'Ti.UI.TabGroup, Ti.UI.Window' });
...
function titleAttributesShadowColor(modifiersAndValues) {
	return processProperties({ 'prop': 'titleAttributes: shadow - iOS Only', 'component': 'Ti.UI.TabGroup, Ti.UI.Window' }, {
...
function titleAttributesColor(modifiersAndValues) {
	return processProperties({ 'prop': 'titleAttributes: color - iOS Only', 'component': 'Ti.UI.TabGroup, Ti.UI.Window' }, {
...
function touchFeedbackColor(modifiersAndValues) {
	return processProperties({ 'prop': 'touchFeedbackColor - Android Only', 'component': 'Ti.UI.View' }, {
...
function flagSecure() {
	return processProperties({ 'prop': 'flagSecure - Android Only', 'component': 'Ti.UI.Window' }, {
...
function overlay() {
	return processProperties({ 'prop': 'overlayEnabled - iOS Only', 'component': 'Ti.UI.ScrollableView' }, {
...
function exitOnClose() {
	return processProperties({ 'prop': 'exitOnClose - Android Only', 'component': 'Ti.UI.TabGroup, Ti.UI.Window' }, {
...
function scrollType() {
	return processProperties({ 'prop': 'scrollType - Android Only', 'component': 'Ti.UI.ScrollView' }, {
...
function swipeToClose() {
	return processProperties({ 'prop': 'swipeToClose - iOS Only', 'component': 'Ti.UI.Window' }, {
...
function preventDefaultImage() {
	return processProperties({ 'prop': 'preventDefaultImage - iOS Only', 'component': 'Ti.UI.ImageView' }, {
...
function smoothScrollOnTabClick() {
	return processProperties({ 'prop': 'smoothScrollOnTabClick - Android Only', 'component': 'Ti.UI.TabGroup' }, {
