...
(function constructor() {
	...
	let combinedColors = { transparente: 'transparent', ...defaultColors };
	...
	convertedStyles += helpers.borderRadiusExtraStyles({ none: 0, sm: '0.125rem', default: '0.25rem', md: '0.375rem', lg: '0.5rem', ...combinedSpacing });
