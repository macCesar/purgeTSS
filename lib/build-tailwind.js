...
(function constructor() {
	...
	convertedStyles += helpers.backgroundGradient(combinedColors);
	convertedStyles += helpers.backgroundLinearGradient();
	convertedStyles += helpers.backgroundRadialGradient();
	...
	convertedStyles += helpers.borderRadius({ ...combinedSpacing, ...defaultTheme.borderRadius });
	...
	convertedStyles += helpers.boxShadow();
	...
	convertedStyles += helpers.hintTextColor(combinedColors);
	...
	convertedStyles += helpers.theme();
	convertedStyles += helpers.tiMedia();
	convertedStyles += helpers.tintColor(combinedColors);
	convertedStyles += helpers.titleAttributesColor(combinedColors);
	convertedStyles += helpers.titleAttributesShadow();
	convertedStyles += helpers.titleAttributesShadowColor(combinedColors);
	...
	convertedStyles += helpers.viewShadowColor(combinedColors);
