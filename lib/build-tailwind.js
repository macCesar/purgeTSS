...
(function constructor() {
	...
	convertedStyles += helpers.customRules({ default: { layout: 'horizontal' }, ios: { clipMode: 'Ti.UI.iOS.CLIP_MODE_DISABLED' } }, '.horizontal');
	convertedStyles += helpers.customRules({ default: { layout: 'vertical' }, ios: { clipMode: 'Ti.UI.iOS.CLIP_MODE_DISABLED' } }, '.vertical');
	...
	convertedStyles += helpers.contentWidth();
