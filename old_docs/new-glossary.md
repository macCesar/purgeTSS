...
'.current-page-slate-200': { currentPageIndicatorColor: '#e2e8f0' }
'.current-page-slate-300': { currentPageIndicatorColor: '#cbd5e1' }
'.current-page-slate-400': { currentPageIndicatorColor: '#94a3b8' }
'.current-page-slate-500': { currentPageIndicatorColor: '#64748b' }
'.current-page-slate-600': { currentPageIndicatorColor: '#475569' }
'.current-page-slate-700': { currentPageIndicatorColor: '#334155' }
'.current-page-slate-800': { currentPageIndicatorColor: '#1e293b' }
'.current-page-slate-900': { currentPageIndicatorColor: '#0f172a' }
'.current-page-gray-50': { currentPageIndicatorColor: '#f9fafb' }
'.current-page-gray-100': { currentPageIndicatorColor: '#f3f4f6' }
'.current-page-gray-200': { currentPageIndicatorColor: '#e5e7eb' }
'.current-page-gray-300': { currentPageIndicatorColor: '#d1d5db' }
'.current-page-gray-400': { currentPageIndicatorColor: '#9ca3af' }
'.current-page-gray-500': { currentPageIndicatorColor: '#6b7280' }
'.current-page-gray-600': { currentPageIndicatorColor: '#4b5563' }
'.current-page-gray-700': { currentPageIndicatorColor: '#374151' }
'.current-page-gray-800': { currentPageIndicatorColor: '#1f2937' }
'.current-page-gray-900': { currentPageIndicatorColor: '#111827' }
'.current-page-zinc-50': { currentPageIndicatorColor: '#fafafa' }
'.current-page-zinc-100': { currentPageIndicatorColor: '#f4f4f5' }
'.current-page-zinc-200': { currentPageIndicatorColor: '#e4e4e7' }
'.current-page-zinc-300': { currentPageIndicatorColor: '#d4d4d8' }
'.current-page-zinc-400': { currentPageIndicatorColor: '#a1a1aa' }
'.current-page-zinc-500': { currentPageIndicatorColor: '#71717a' }
'.current-page-zinc-600': { currentPageIndicatorColor: '#52525b' }
'.current-page-zinc-700': { currentPageIndicatorColor: '#3f3f46' }
'.current-page-zinc-800': { currentPageIndicatorColor: '#27272a' }
'.current-page-zinc-900': { currentPageIndicatorColor: '#18181b' }
'.current-page-neutral-50': { currentPageIndicatorColor: '#fafafa' }
'.current-page-neutral-100': { currentPageIndicatorColor: '#f5f5f5' }
'.current-page-neutral-200': { currentPageIndicatorColor: '#e5e5e5' }
'.current-page-neutral-300': { currentPageIndicatorColor: '#d4d4d4' }
'.current-page-neutral-400': { currentPageIndicatorColor: '#a3a3a3' }
'.current-page-neutral-500': { currentPageIndicatorColor: '#737373' }
'.current-page-neutral-600': { currentPageIndicatorColor: '#525252' }
'.current-page-neutral-700': { currentPageIndicatorColor: '#404040' }
'.current-page-neutral-800': { currentPageIndicatorColor: '#262626' }
'.current-page-neutral-900': { currentPageIndicatorColor: '#171717' }
'.current-page-stone-50': { currentPageIndicatorColor: '#fafaf9' }
'.current-page-stone-100': { currentPageIndicatorColor: '#f5f5f4' }
'.current-page-stone-200': { currentPageIndicatorColor: '#e7e5e4' }
'.current-page-stone-300': { currentPageIndicatorColor: '#d6d3d1' }
'.current-page-stone-400': { currentPageIndicatorColor: '#a8a29e' }
'.current-page-stone-500': { currentPageIndicatorColor: '#78716c' }
'.current-page-stone-600': { currentPageIndicatorColor: '#57534e' }
'.current-page-stone-700': { currentPageIndicatorColor: '#44403c' }
'.current-page-stone-800': { currentPageIndicatorColor: '#292524' }
'.current-page-stone-900': { currentPageIndicatorColor: '#1c1917' }
...
'.page-slate-200': { pageIndicatorColor: '#e2e8f0' }
'.page-slate-300': { pageIndicatorColor: '#cbd5e1' }
'.page-slate-400': { pageIndicatorColor: '#94a3b8' }
'.page-slate-500': { pageIndicatorColor: '#64748b' }
'.page-slate-600': { pageIndicatorColor: '#475569' }
'.page-slate-700': { pageIndicatorColor: '#334155' }
'.page-slate-800': { pageIndicatorColor: '#1e293b' }
'.page-slate-900': { pageIndicatorColor: '#0f172a' }
'.page-gray-50': { pageIndicatorColor: '#f9fafb' }
'.page-gray-100': { pageIndicatorColor: '#f3f4f6' }
'.page-gray-200': { pageIndicatorColor: '#e5e7eb' }
'.page-gray-300': { pageIndicatorColor: '#d1d5db' }
'.page-gray-400': { pageIndicatorColor: '#9ca3af' }
'.page-gray-500': { pageIndicatorColor: '#6b7280' }
'.page-gray-600': { pageIndicatorColor: '#4b5563' }
'.page-gray-700': { pageIndicatorColor: '#374151' }
'.page-gray-800': { pageIndicatorColor: '#1f2937' }
'.page-gray-900': { pageIndicatorColor: '#111827' }
'.page-zinc-50': { pageIndicatorColor: '#fafafa' }
'.page-zinc-100': { pageIndicatorColor: '#f4f4f5' }
'.page-zinc-200': { pageIndicatorColor: '#e4e4e7' }
'.page-zinc-300': { pageIndicatorColor: '#d4d4d8' }
'.page-zinc-400': { pageIndicatorColor: '#a1a1aa' }
'.page-zinc-500': { pageIndicatorColor: '#71717a' }
'.page-zinc-600': { pageIndicatorColor: '#52525b' }
'.page-zinc-700': { pageIndicatorColor: '#3f3f46' }
'.page-zinc-800': { pageIndicatorColor: '#27272a' }
'.page-zinc-900': { pageIndicatorColor: '#18181b' }
'.page-neutral-50': { pageIndicatorColor: '#fafafa' }
'.page-neutral-100': { pageIndicatorColor: '#f5f5f5' }
'.page-neutral-200': { pageIndicatorColor: '#e5e5e5' }
'.page-neutral-300': { pageIndicatorColor: '#d4d4d4' }
'.page-neutral-400': { pageIndicatorColor: '#a3a3a3' }
'.page-neutral-500': { pageIndicatorColor: '#737373' }
'.page-neutral-600': { pageIndicatorColor: '#525252' }
'.page-neutral-700': { pageIndicatorColor: '#404040' }
'.page-neutral-800': { pageIndicatorColor: '#262626' }
'.page-neutral-900': { pageIndicatorColor: '#171717' }
'.page-stone-50': { pageIndicatorColor: '#fafaf9' }
'.page-stone-100': { pageIndicatorColor: '#f5f5f4' }
'.page-stone-200': { pageIndicatorColor: '#e7e5e4' }
'.page-stone-300': { pageIndicatorColor: '#d6d3d1' }
'.page-stone-400': { pageIndicatorColor: '#a8a29e' }
'.page-stone-500': { pageIndicatorColor: '#78716c' }
'.page-stone-600': { pageIndicatorColor: '#57534e' }
'.page-stone-700': { pageIndicatorColor: '#44403c' }
'.page-stone-800': { pageIndicatorColor: '#292524' }
'.page-stone-900': { pageIndicatorColor: '#1c1917' }
...
'.paging-slate-200': { pagingControlColor: '#e2e8f0' }
'.paging-slate-300': { pagingControlColor: '#cbd5e1' }
'.paging-slate-400': { pagingControlColor: '#94a3b8' }
'.paging-slate-500': { pagingControlColor: '#64748b' }
'.paging-slate-600': { pagingControlColor: '#475569' }
'.paging-slate-700': { pagingControlColor: '#334155' }
'.paging-slate-800': { pagingControlColor: '#1e293b' }
'.paging-slate-900': { pagingControlColor: '#0f172a' }
'.paging-gray-50': { pagingControlColor: '#f9fafb' }
'.paging-gray-100': { pagingControlColor: '#f3f4f6' }
'.paging-gray-200': { pagingControlColor: '#e5e7eb' }
'.paging-gray-300': { pagingControlColor: '#d1d5db' }
'.paging-gray-400': { pagingControlColor: '#9ca3af' }
'.paging-gray-500': { pagingControlColor: '#6b7280' }
'.paging-gray-600': { pagingControlColor: '#4b5563' }
'.paging-gray-700': { pagingControlColor: '#374151' }
'.paging-gray-800': { pagingControlColor: '#1f2937' }
'.paging-gray-900': { pagingControlColor: '#111827' }
'.paging-zinc-50': { pagingControlColor: '#fafafa' }
'.paging-zinc-100': { pagingControlColor: '#f4f4f5' }
'.paging-zinc-200': { pagingControlColor: '#e4e4e7' }
'.paging-zinc-300': { pagingControlColor: '#d4d4d8' }
'.paging-zinc-400': { pagingControlColor: '#a1a1aa' }
'.paging-zinc-500': { pagingControlColor: '#71717a' }
'.paging-zinc-600': { pagingControlColor: '#52525b' }
'.paging-zinc-700': { pagingControlColor: '#3f3f46' }
'.paging-zinc-800': { pagingControlColor: '#27272a' }
'.paging-zinc-900': { pagingControlColor: '#18181b' }
'.paging-neutral-50': { pagingControlColor: '#fafafa' }
'.paging-neutral-100': { pagingControlColor: '#f5f5f5' }
'.paging-neutral-200': { pagingControlColor: '#e5e5e5' }
'.paging-neutral-300': { pagingControlColor: '#d4d4d4' }
'.paging-neutral-400': { pagingControlColor: '#a3a3a3' }
'.paging-neutral-500': { pagingControlColor: '#737373' }
'.paging-neutral-600': { pagingControlColor: '#525252' }
'.paging-neutral-700': { pagingControlColor: '#404040' }
'.paging-neutral-800': { pagingControlColor: '#262626' }
'.paging-neutral-900': { pagingControlColor: '#171717' }
'.paging-stone-50': { pagingControlColor: '#fafaf9' }
'.paging-stone-100': { pagingControlColor: '#f5f5f4' }
'.paging-stone-200': { pagingControlColor: '#e7e5e4' }
'.paging-stone-300': { pagingControlColor: '#d6d3d1' }
'.paging-stone-400': { pagingControlColor: '#a8a29e' }
'.paging-stone-500': { pagingControlColor: '#78716c' }
'.paging-stone-600': { pagingControlColor: '#57534e' }
'.paging-stone-700': { pagingControlColor: '#44403c' }
'.paging-stone-800': { pagingControlColor: '#292524' }
'.paging-stone-900': { pagingControlColor: '#1c1917' }
