...
```css
// Property(ies): autoAdjustScrollViewInsets
...
```css
// Property(ies): includeOpaqueBars
// Component(s): Ti.UI.Window
...
```css
// Property(ies): largeTitleEnabled
// Component(s): Ti.UI.Window
...
```css
// Property(ies): keepSectionsInSearch
