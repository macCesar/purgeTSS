...
We've decided to remove several icon libraries and leave only the `Font Awesome 6 Free`, `Material Icons` icons and `Framework 7` icons, as the official icon fonts for **PurgeTSS**.
