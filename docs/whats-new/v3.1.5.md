...
When creating a new project with `purgetss create 'project of the name' --tailwind`, the `package.json` file was throwing an error if the name of the project contain spaces.
